...
33 categories total — 30 enabled by default. The three opt-IN checks
...
The 33 checks are grouped into 5 categories displayed in this order
...
``CATEGORY_METADATA`` insertion order):
  ...
  1. Content (19) — empty_target, untranslated_segment,
     inconsistent_translation, repeated_words, length_ratio, urls,
     emails, first_letter_case, alluppercase_mismatch,
     camelcase_mismatch, bracket_balance, repeated_punctuation,
     final_punctuation_mismatch, double_spaces, whitespace_edges,
     control_characters, mixed_scripts, custom_forbidden_regex*,
     custom_required_regex*.
  2. Numeric Elements (6) — number_mismatch, unit_mismatch,
     symbol_mismatch, alphanum_id_mismatch, number_format_mismatch,
